<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NuovoCliente.aspx.cs" Inherits="WebForm_Database.CMS.NuovoCliente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Nuovo Cliente</h1>

    <asp:DetailsView ID="dvNuovoCliente" runat="server" Height="50px" Width="90%" AutoGenerateRows="False" CellPadding="4" DataKeyNames="CustomerID" DataSourceID="sdsCliente" DefaultMode="Insert" ForeColor="#333333" GridLines="None">
