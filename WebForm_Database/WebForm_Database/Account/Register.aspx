<%@ Page Title="Registrazione" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebForm_Database.Account.Register" %>
    ...
    <main aria-labelledby="title">
        ...
        <div class="row">
            <div class="offset-md-2 col-md-10">
                <asp:Button runat="server" OnClick="CreateUser_Click" Text="Esegui registrazione" CssClass="btn btn-outline-dark" />
            </div>
        </div>
    </main>
</asp:Content>
